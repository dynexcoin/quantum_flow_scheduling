...
class TestData(unittest.TestCase):
    ...
    def test_prep_solution_for_plotting(self):
        ...
        job_start_time, processing_time = job_plotter.plot_solution(test_data, solution)
        self.assertEqual(
            {"0": [8.0, 0.0, 3.0], "1": [11.0, 3.0, 7.0], "2": [14.0, 5.0, 9.0]}, job_start_time
        )

        self.assertEqual({"0": [2, 3, 4], "1": [3, 2, 2], "2": [0, 3, 5]}, processing_time)
